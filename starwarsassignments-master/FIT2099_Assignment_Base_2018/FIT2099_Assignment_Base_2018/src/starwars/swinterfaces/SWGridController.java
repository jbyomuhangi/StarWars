...
public class SWGridController implements GridController {
	...
	public SWGridController(SandcrawlerWorld inside) {
		this.grid2 = inside.getGrid();
		
		SWGridController.ui = new SWGridTextInterface(this.grid2, false); //use a Text Interface to interact
	}
