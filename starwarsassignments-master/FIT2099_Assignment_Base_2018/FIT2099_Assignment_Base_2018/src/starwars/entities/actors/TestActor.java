...
public class TestActor extends SWActor {
	 ...
	 */
	public void act() {
		say(this.getShortDescription() + " is standing still at " + ((SWWorld)this.world).getEntityManager().whereIs(this).getShortDescription());
		describeScene();
	}
	...
	public void describeScene() {
		...
		SWLocation location = ((SWWorld)this.world).getEntityManager().whereIs(this);
		...
		List<SWEntityInterface> contents = ((SWWorld)this.world).getEntityManager().contents(location);
