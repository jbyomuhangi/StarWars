...
public class Application {
	...
	public static void main(String args[]) {
		...
		theScheduler = new Scheduler(1, world);
	...
	public static SWWorld getSWWorld(){return world;}
	public static Scheduler getScheduler(){return theScheduler;}
}
