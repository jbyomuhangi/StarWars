...
public abstract class SWAction extends Action implements SWActionInterface {
	...
	private static EntityManager<SWEntityInterface, SWLocation> entityManager;
	 ...
	 */
	public SWAction(MessageRenderer m, SWWorld currentWorld) {
		super(m);
		if (currentWorld instanceof SWWorld) {
			 entityManager = SWWorld.getEntitymanager();
		}
		else if(currentWorld instanceof SandcrawlerWorld) {
			entityManager = SandcrawlerWorld.getEntitymanager();
		}
	}
